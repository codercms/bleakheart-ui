...
This app is a desktop UI for recording physiological data using the [
`bleakheart`](https://github.com/fsmeraldi/bleakheart) library.
...
- Main Window (Idle)
  <p>
    <a href="docs/screenshots/main_window_idle.png" target="_blank" rel="noopener noreferrer">
      <img src="docs/screenshots/main_window_idle.png" alt="BleakHeart UI main window idle screenshot" height="300" />
    </a>
  </p>

- Main Window (Recording)
  <p>
    <a href="docs/screenshots/main_window_recording.png" target="_blank" rel="noopener noreferrer">
      <img src="docs/screenshots/main_window_recording.png" alt="BleakHeart UI main window recording screenshot" height="300" />
    </a>
  </p>

- Session Details Window
  <p>
    <a href="docs/screenshots/session_details_window.png" target="_blank" rel="noopener noreferrer">
      <img src="docs/screenshots/session_details_window.png" alt="BleakHeart UI session details window screenshot" height="300" />
    </a>
  </p>
